...
Todas essas tecnologias têm em comum o fato de que usam algoritmos de aprendizado de máquina que são impulsionados por um grande volume de dados e um grande poder de computação, com as GPUs.
...
Ou seja, estamos vivendo um momento extremamente empolgante e ao mesmo tempo assustador, onde o tempo todo ouvimos dizer sobre uma nova IA e como ela vai mudar o mundo.

Ao mesmo tempo que vemos aplicações incríveis, como o uso de IA para diagnosticar doenças e salvar vidas, vemos também a possibilidade da IA substituir humanos e gerar desemprego; ou ser usada para criar fake news e desinformação.

É por isso que o meu maior objetivo com esse curso é te informar. Eu não tenho bola de cristal, então não posso afirmar o que vai acontecer no futuro, se os robôs vão dominar o mundo ou não. O que eu posso te adiantar é que existem pontos positivos e pontos negativos relacionados a essas tecnologias e eu quero te passar esse panorama geral para que você possa se situar nesse universo.

Então siga comigo nesse curso e vamos aprender mais sobre IA.
